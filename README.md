# Daniel González - Desarrollador de Software 🚀

¡Hola! Soy **Daniel González**, un desarrollador de software apasionado por la **programación Full Stack**, bases de datos y automatizaciones.

Actualmente trabajo con **Java Spring Boot** en el backend y **Angular** en el frontend, con más de **4 años de experiencia práctica** en proyectos académicos y personales.
...
### Gestión de Nómina
- Backend con Spring Boot, frontend con Angular
- Integración con PostgreSQL y automatización de correos

### Sistema de Información Científica
- Corrección de XML y actualización de sitio web con HTML, CSS y JavaScript

### Sistema de Control de Impresiones
- PHP y SQL, administración de usuarios y soporte técnico
...
📧 danielgr_ic@outlook.com  
🌐 [LinkedIn](https://www.linkedin.com/in/juan-daniel-gonzález-reyes-660a33205)
